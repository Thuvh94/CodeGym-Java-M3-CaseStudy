...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <ul class="list-inline">
                ...
                <li class="list-inline-item"><span>Khẩu phần:</span> <c:out value="${recipe.getYield()}"></c:out> người
                </li>
                <li class="list-inline-item"><span>Thời gian nấu / nướng:</span> <c:out
                        value="${recipe.getCookTime()}"/> giờ
                </li>
            </ul>
            <ul class="list-inline">
            ...
            <figure class="figure">
                <img src="../Image/${recipe.getCoverImg()}" class="figure-img img-fluid rounded"
                     alt="${recipe.getCoverImg()}" style="width: 800px;height: 400px">
            </figure>
    ...
    <div class="col-sm-2 sidenav">
        <div class="well">
            ...
            <h3>About me</h3>
            <p style="text-align: left">Chào mừng bạn đến với <span
                    style="font-weight: bold">The little whisk!</span><br><br>
                Tại <span style="font-weight: bold">The little whisk!</span>, mình sẽ chia sẻ các công thức làm bánh
                thật ngon cùng với nhiều mẹo và
                cách khắc phục sự cố để giúp bạn thành công ngay trong lần thử đầu tiên ^^<br><br>
                Mỗi công thức bánh tại The little whisk đều là kết quả của những lần thử - sai để cuối cùng cho ra một
                công thức ưng ý nhất! <br>
...
<script>
    document.getElementsByClassName("summerNote").onload = function () {
        myFunction()
    };
